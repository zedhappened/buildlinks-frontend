...
const AdminCategoryCard = ({ category, parent }) => {
    return (
        <div className="flex flex-col w-56 border hover:border-primary transition-all ease-in-out rounded-sm bg-dull">
            ...
            <div className="basis-5/12 bg-neutral">
                ...
                <p className="text-xs px-4 py-2 border-t">
                    <b>Show on Navbar:</b> {category.showOnNavbar.toString()}
                </p>
                <p className="text-xs px-4 py-2 border-t">
