...
const AdminSidebar = ({ show }) => {
  return (
    <div
      className={
        "fixed z-10 top-20 left-0 bottom-0 bg-secondaryHover border-r-2 shadow-inner w-0 md:w-64 transition-all duration-400 delay-200" +
        (show ? " !w-64" : "")
      }
    >
      <nav
        className={
          "flex flex-col gap-3 text-lg font-semibold p-4 text-secondary invisible md:visible delay-0" +
          (show ? " !visible !delay-300" : "")
        }
      >
        <NavLink
